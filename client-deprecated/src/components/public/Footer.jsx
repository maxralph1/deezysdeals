...
export default function Footer() {
    return (
        <footer className="bg-dark text-white mt-4">
            <div className="intro d-flex flex-column" style={{ backgroundSize: 'cover', height: '50vh' }}>
                <div className="d-flex align-items-center justify-content-between flex-wrap gap-2 h-100">
                    <div className="d-flex flex-column m-auto gap-2">
                        <span className="text-dark fw-semibold">Get it Before Everyone Else</span>
            ...
            <section className="contact d-flex justify-content-between py-4 px-3">
                ...
                <section className="social d-flex gap-2"> 
                    <a href="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-tiktok text-white"
                            viewBox="0 0 16 16">
                            <path
                    ...
                    <a href="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-instagram text-white"
                            viewBox="0 0 16 16">
                            <path
                    ...
                    <a href="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-facebook text-white"
                            viewBox="0 0 16 16">
                            <path
                    ...
                    <a href="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-twitter-x text-white"
                            viewBox="0 0 16 16">
                            <path
