                ...
                <div className="dashboard-content pt-3"> 
                    ...
                    <section className="py-4">
                        <ul className="list-unstyled d-flex flex-column gap-5">
                            { (products?.data?.length > 1) && (products?.data?.map((product, index) => {
                                return (
                                    <li key={ product?._id } className="box-shadow-1 border-radius-25 py-3 px-2 cursor-pointer">
                                        <div className="text-dark">
                                            <div className="d-flex justify-content-between align-items-center flex-wrap pb-2 px-3">
                                                <span className="fw-semibold">#
                                                    { (products?.meta?.current_page != 1) 
                                                        ? (((products?.meta?.current_page - 1) * products?.meta?.limit) + (index + 1))
                                                        : products?.meta?.current_page * (index + 1) }
                                                </span>
                                                <span 
                                                    type="button" 
                                                    data-bs-toggle="modal" data-bs-target={ `#product${product?._id}Modal` }
                                            ...
                                            <div className="row align-items-center g-3 px-3 py-1">
                                                <div className="col-md-5">
                                                    <div id={`carousel${product?._id}Image`} className="carousel slide">
                                                        <div className="carousel-inner position-relative" style={{ width: '215px', height: '215px' }}> 
                                                            ...
                                                            <div>
                                                                <button className="carousel-control-prev position-absolute left-0 ps-1" type="button" data-bs-target={`#carousel${product?._id}Image`} data-bs-slide="prev">
                                                                    <span>
                                                                ...
                                                                <button className="carousel-control-next position-absolute right-0 pe-1" type="button" data-bs-target={`#carousel${product?._id}Image`} data-bs-slide="next">
                                                                    <span>
                                                ...
                                                <div className="col-md-7">
                                                    <div className="card-body d-flex flex-column gap-0"> 
                                                        <h4 className="card-title fs-6">{ ((product?.title)?.length > 250) ? ((product?.title)?.slice(0,250) + ' ...') : product?.title }</h4>
                                                        ...
                                                        <span className="card-text"><small><s>$86.99</s></small>&nbsp;<span className="fw-semibold">${ (product?.retail_price) }</span></span>
                                                        ...
                                                        { (product?.order?.delivery_date) &&
                                                            <span className="card-text">
                                                                Delivered&nbsp;
                                                                    <span className="fw-semibold">
                                                                        { dayjs.utc(product?.order?.delivery_date).fromNow() } 
                                                                    </span>
                                                            </span> }
                                                    </div>
                                                </div> 
                                        ...
                                        <div className="modal fade" id={ `product${product?._id}Modal` } tabIndex="-1" aria-labelledby={ `product${product?._id}ModalLabel` } aria-hidden="true">
                                            <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
                                                <div className="modal-content">
                                                    <div className="modal-header d-flex justify-content-end align-items-center gap-1">
                                                        <h3 className="modal-title fs-5 d-none" id={ `product${product?._id}ModalLabel` }>{ product?.title }</h3>
                                                    ...
                                                    <div className="modal-body">
                                                        <div className="row align-items-center justify-content-between p-4 pt-2 g-3">
                                                            <div className="col-md-5">
                                                                <div id={`carouselModal${product?._id}Image`} className="carousel slide">
                                                                    <div className="carousel-inner position-relative" style={{ width: '215px', height: '215px' }}>
                                                                        <div className="images">
                                                                            { (product?.images?.map((image, index) => {
                                                                                return (
                                                                        ...
                                                                        <div>
                                                                            <button className="carousel-control-prev position-absolute left-0 ps-1" type="button" data-bs-target={`#carouselModal${product?._id}Image`} data-bs-slide="prev">
                                                                                <span>
                                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-arrow-left-circle-fill" viewBox="0 0 16 16">
                                                                                        <path d="M8 0a8 8 0 1 0 0 16A8 8 0 0 0 8 0m3.5 7.5a.5.5 0 0 1 0 1H5.707l2.147 2.146a.5.5 0 0 1-.708.708l-3-3a.5.5 0 0 1 0-.708l3-3a.5.5 0 1 1 .708.708L5.707 7.5z"/>
                                                                                    </svg>
                                                                            ...
                                                                            <button className="carousel-control-next position-absolute right-0 pe-1" type="button" data-bs-target={`#carouselModal${product?._id}Image`} data-bs-slide="next">
                                                                                <span>
                                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-arrow-right-circle-fill" viewBox="0 0 16 16">
                                                                                        <path d="M8 0a8 8 0 1 1 0 16A8 8 0 0 1 8 0M4.5 7.5a.5.5 0 0 0 0 1h5.793l-2.147 2.146a.5.5 0 0 0 .708.708l3-3a.5.5 0 0 0 0-.708l-3-3a.5.5 0 1 0-.708.708L10.293 7.5z"/>
                                                                                    </svg>
                                                            ...
                                                            <div className="col-md-7">
                                                                <div className="card-body d-flex flex-column gap-0">
                                                                    <h4 className="card-title fs-4">{ product?.title }</h4>
                                                                    <span className="card-text"><small>Options: <span className="fw-semibold">7
                                                                                sizes</span></small></span>
                                                                    <span className="card-text">10k+ bought in the last month</span>
                                                                    <span className="card-text"><small><s>$86.99</s></small>&nbsp;<span
                                                                            className="fw-semibold">${ (product?.retail_price) }</span></span>
                                                                    <span className="card-text">
                                                                        <small>
                                                                            <span className="bg-success border-radius-35 px-2 py-1 text-white fw-semibold">
                                                                                Saved $15.00
                                                        ...
                                                        <div className="d-flex justify-content-end px-4 pt-4 pb-2">
                                                            <span className="btn btn-sm btn-dark border-radius-35 d-flex align-items-center">
                                                                <Link to={ route('products.show', { id: product?._id}) } target="_blank"  className="text-decoration-none ps-1 fw-semibold text-white">
