        ...
        <Layout>
            <div className="main">
                <div className="dashboard-content pt-3"> 
                    <h2 className="border-bottom pb-1 fs-4">Clients</h2> 
                    ...
                    <div className="d-flex justify-content-between flex-wrap gap-2"> 
                        <div className="search">
                            <div className="search-container border border-dark" style={{ maxWidth: '375px' }}>
                                ...
                                <input type="text" placeholder="Search client ..." className="" />
                            ...
                            <li className="box-shadow-1 border-radius-25 py-4 px-2 cursor-pointer">
                                <div className="text-dark px-3">
                                    <div className="d-flex justify-content-between align-items-center flex-wrap pb-2">
                                        ...
                                        <Link 
                                            to={ route('home.clients.show', {username: 'paedazi'})}
                                    ...
                                    <div className="amount-and-client d-flex flex-column gap-2">
                                        ...
                                        <span>Total amount spent:&nbsp;<span className="fw-semibold fs-5">$420.52</span></span>
                                        <span>Total orders:&nbsp;<span className="fw-semibold">10</span></span>
                                        <span>Total items purchased:&nbsp;<span className="fw-semibold">32</span></span>
                                    </div>
                                </div> 
                            </li> 
                            <li className="box-shadow-1 border-radius-25 py-4 px-2 cursor-pointer">
                                <div className="text-dark px-3">
                                    ...
                                    <div className="amount-and-client d-flex flex-column gap-2">
                                        ...
                                        <span>Total amount spent:&nbsp;<span className="fw-semibold fs-5">$123.45</span></span>
                                        <span>Total orders:&nbsp;<span className="fw-semibold">12</span></span>
                                        <span>Total items purchased:&nbsp;<span className="fw-semibold">34</span></span>
                                    </div>
                                </div> 
                            </li> 
                            <li className="box-shadow-1 border-radius-25 py-4 px-2 cursor-pointer">
                                <div className="text-dark px-3">
                                    ...
                                    <div className="amount-and-client d-flex flex-column gap-2">
                                        ...
                                        <span>Total amount spent:&nbsp;<span className="fw-semibold fs-5">$400.52</span></span>
                                        <span>Total orders:&nbsp;<span className="fw-semibold">7</span></span>
                                        <span>Total items purchased:&nbsp;<span className="fw-semibold">32</span></span>
                                    </div>
                                </div> 
                            </li> 
