...
export default function SideBar() {
    return (
        <>
            <nav className="sidebar d-none d-md-block col-md-3 col-lg-2 position-relative">
                ...
                <section className="pt-3">
                    <ul className="nav flex-column gap-1">
                        <li className="nav-item p-2 d-flex align-items-center concave border-radius-35">
                            ...
                            <a href="#" className="text-decoration-none text-dark fw-semibold fs-6 px-2">Home</a>
                        </li>
                        <li className="nav-item p-2 d-flex align-items-center">
                            ...
                            <a href="#" className="text-decoration-none text-dark fw-semibold fs-6 px-2">Sales</a>
                        </li>
                        <li className="nav-item p-2 d-flex align-items-center">
                            ...
                            <a href="#" className="text-decoration-none text-dark fw-semibold fs-6 px-2">Profit</a>
                        </li>
                        <li className="nav-item p-2 d-flex align-items-center">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <a href="#" className="text-decoration-none text-dark fw-semibold fs-6 px-2">Orders</a>
                        </li>
                        <li className="nav-item p-2 d-flex align-items-center">
                            ...
                            <a href="#" className="text-decoration-none text-dark fw-semibold fs-6 px-2">Payments</a>
                        </li>
                        <li className="nav-item p-2 d-flex align-items-center"> 
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g id="User / User_02">
                            ...
                            <a href="#" className="text-decoration-none text-dark fw-semibold fs-6 px-2">Clients</a>
                        </li>
                        <li className="nav-item p-2 d-flex align-items-center"> 
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g id="style=linear">
                            ...
                            <a href="#" className="text-decoration-none text-dark fw-semibold fs-6 px-2">Notifications</a>
                        </li>
                        <li className="nav-item p-2 d-flex align-items-center"> 
                            ...
                            <a href="#" className="text-decoration-none text-dark fw-semibold fs-6 px-2">Profile</a>
                        </li>
                    </ul>
                </section>
